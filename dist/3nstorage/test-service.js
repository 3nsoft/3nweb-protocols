...
var storage = require('./3nstorage-service/3nstorage-app');
...
function makeApp(dataFolder) {
    ...
    app.use('/3nstorage', storage.makeApp(ownersSessions, sharingSessions, users, midAuthorizer.validate));
    app.use('/3nstorage-users', userSettingsApp.makeApp(userSettingSessions, users, midAuthorizer.validate));
    return app;
}
