...
import client = require('./client-apps/static-content-server');
import mid = require('./mailerId/test-service');
import mail = require('./asmail/test-service');
import store = require('./3nstorage/test-service');
...
function createFolder(path: string, doLog?: boolean): void {
	try {
		fs.mkdirSync(path);
